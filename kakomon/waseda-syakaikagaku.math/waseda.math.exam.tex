...
\begin{center}
    ...
    \end{tikzpicture}
\end{center}
\kakkoichib　$直線\mathrm{OA}の式が,y=xなので,求める面積Tとすると,Tは上図の斜線部と網目部を合わせた部分であるあから,$
\begin{align*}
...
\noindent\ba{5.1.4}\\
\kangaekata\\
\kakkoni $座標において,\sin^2x や\cos^2x という\ans{2乗の形}は厄介です.なので,半角公式を用いて次数を下げましょう.一応,導出方法を含めて確認しますか.$\\
\koushikia $<半角公式の導出>$\\
$\cos の2倍角の公式より,$
\begin{align*}
...
\begin{align*}
    ...
    &\doti \kotaee{m:(x+1)\sin\theta-y\sin\theta=0}
\end{align*}\\
