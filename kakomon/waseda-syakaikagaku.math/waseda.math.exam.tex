...
\newpage
\subsection{第4回}
4回目の話題は数列です.数学的帰納法や難しい漸化式などの論述を必要とする問題を中心に取り上げたいと思います.\\
\newpage
    \section{早稲田大学過去問解答編}
    \subsection{2023年度実施}
    \reibanichi\\
...
\kakkoshib　\begin{align*}
    (x,y)\in W_4&\doti
        ...
        &\doti-1\leq \exists t\leq1,\begin{cases}
            ...
            y=\dfrac{1}{4}x^2+x+1
        \end{cases}\\\\
        &\doti-1\exists y\leq1\begin{cases}
            t=\dfrac{1}{2}(x+1)\\
            y=\dfrac{1}{4}x^2+x+1
        \end{cases}\\\\
        &\doti \begin{cases}
...
\kakkoichib 　$全事象は,6\cdot5cdot4=120通りである.$\\
ここで,$a=bが成立するのは,$
\begin{align*}
...
\begin{align*}
    \p{\log_22\sqrt{2}}^2&=\log_2\p{\sqrt{b}2\sqrt{2}^a}\\
